    ...
    return (
        <div className='footer'>
            <div>
                <div className='footer-data'>
                    <div className="contact-details">
                        ...
                        <p>Tamilnadu</p>
                        <p>India</p>
                        <p><b>Email:</b>librarian@veltechmultitech.org</p>
                    </div>
                    <div className='usefull-links'>
                        <h1>Usefull Links</h1>
                        <a href='#home'>https://news.un.org/</a>
                        <a href='#home'>https://www.indiatoday.in/blogs-section</a>
                    </div>
            ...
            <div className='copyright-details'>
                <p className='footer-copyright'>&#169; 2023 copyright all right reserved<br /><span>Designed with ❤️ by T Karthick</span></p>
            </div>
        </div>
    )
}
